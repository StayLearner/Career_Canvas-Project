  ...
  return (
    <div className="bg-white">
      <div className="flex items-center justify-between mx-auto max-w-7xl h-16">
        <div>
          <Link to="/">
            <h1 className="text-5xl font-bold text-[#ffba08] cursor-pointer">
            ...
            <div className="flex items-center gap-2">
              <Link to="/login">
                <div className="flex gap-4">
                  ...
                  <Link to="/signup">
                    <Button className="bg-gradient-to-r border-4 border-[#ff9e00] from-[#f7b801] to-[#4cc9f0] text-white py-2 px-6  font-semibold tracking-wide shadow-lg transform transition-all duration-500 ease-in-out hover:bg-gradient-to-l hover:from-[#ff577f] hover:to-[#6A38C2] hover:scale-105 hover:shadow-2xl">
                      {" "}
                      Signup{" "}
                    </Button>
                  </Link>
