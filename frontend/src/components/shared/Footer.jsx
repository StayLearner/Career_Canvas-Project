...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#0fa3b1] to-[#3a86ff] text-white py-8 sm:py-10">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Information */}
          <div>
            <h2 className="text-xl font-bold mb-4 hover:underline transition duration-300">CareerCanvas</h2>
            <p className="text-sm mb-2">📍 Address: Kolkata, West Bengal, India</p>
            <p className="text-sm mb-2">📞 Phone: Coming Soon</p>
            <p className="text-sm mb-2">✉️ Email: support@careercanvas.online</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://techcrunch.com/" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline transition duration-300">Blog</a></li>
              <li><a href="https://www.ambitionbox.com/salaries" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline transition duration-300">Salary Insights</a></li>
              <li><a href="https://resume.io/" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline transition duration-300">Resume Tips</a></li>
              <li><a href="https://www.sydney.edu.au/careers/students/applying-for-jobs/interview-tips.html" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline transition duration-300">Interview Tips</a></li>
              <li><a href="https://www.careercompass.com" target="_blank" rel="noopener noreferrer" className="text-sm hover:underline transition duration-300">Career Development</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-5 sm:gap-6">
          <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="transition-transform transform hover:scale-125">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/linkedin.png" alt="LinkedIn" className="w-7 h-7 sm:w-8 sm:h-8" />
          </a>
          <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transition-transform transform hover:scale-110" aria-label="Instagram">
            ...
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transition-transform transform hover:scale-110" aria-label="YouTube">
              <svg className="w-6 h-6 sm:w-7 sm:h-7" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="transition-transform transform hover:scale-125">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/facebook.png" alt="Facebook" className="w-7 h-7 sm:w-8 sm:h-8" />
          </a>
          <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="transition-transform transform hover:scale-125">
            <img src="https://img.icons8.com/ios-filled/50/ffffff/twitter.png" alt="Twitter" className="w-7 h-7 sm:w-8 sm:h-8" />
          </a>
        </div>

        <div className="text-center mt-8">
          <p className="text-sm">© 2026 CareerCanvas. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
