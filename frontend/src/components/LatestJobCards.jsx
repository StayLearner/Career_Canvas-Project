    ...
    >
      ...
      <div className="space-y-4 z-10 relative">
        ...
        <div className="flex justify-between items-start gap-4">
          <div className="flex items-center gap-3">
            ...
            <div className="text-left min-w-0">
              <h3 className="font-semibold text-sm text-slate-800 dark:text-slate-300 group-hover:text-slate-950 dark:group-hover:text-white transition-colors truncate">
                {job?.company?.name}
              </h3>
        ...
        <div className="text-left">
          ...
          <p className="text-xs text-slate-605 dark:text-slate-400 line-clamp-3 mt-2 leading-relaxed">
            {job?.description}
          </p>
        </div>
      </div>
