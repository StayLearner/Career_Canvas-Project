        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
              {features.map((feat) => {
                ...
                return (
                  <div key={feat.title} className="glass-panel p-5 rounded-2xl flex flex-col gap-3 group border-slate-200 dark:border-white/10 hover:border-violet-500/20 transition-all duration-300">
          ...
          <div className="lg:col-span-6 relative">
            ...
            <motion.div
              ...
              className="glass-panel p-6 rounded-3xl border border-slate-202 dark:border-white/10 shadow-2xl relative overflow-hidden"
            >
