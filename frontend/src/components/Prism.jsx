...
/**
 * Prism – React Bits WebGL spectral background.
 * Converted from TypeScript to plain JSX for this project.
 * Uses OGL for minimal WebGL rendering.
 */
const Prism = ({
  height = 3.5,
  baseWidth = 5.5,
  ...
  useEffect(() => {
    ...
    function render(t) {
      ...
      if (animationType === 'hover') {
        ...
        // 'rotate' – use built-in wobble, identity matrix
