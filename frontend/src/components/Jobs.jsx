...
const Jobs = () => {
    ...
    return (
        <div className="bg-[#FAFBFC] dark:bg-[#08070d] min-h-screen text-slate-800 dark:text-slate-100 transition-colors duration-500 font-sans pb-16 relative">
            ...
            {/* Content pushed down to clear Navbar (top-4 + ~60px height = ~80px) + Search band (~72px) */}
                    ...
                    <>
                        ...
                        >
                            <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-white/5">
                                ...
                                <button
                                    onClick={() => setIsDrawerOpen(false)}
                                    className="p-1.5 rounded-full border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/5 text-slate-500 dark:text-slate-400 transition bg-transparent cursor-pointer"
                                >
                                    <X size={18} />
                                </button>
                            </div>
