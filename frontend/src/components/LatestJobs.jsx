...
const LatestJobs = () => {
  ...
  return (
    <section id="latest-jobs-grid" className="py-20 lg:py-24 relative overflow-hidden bg-slate-950/10 dark:bg-slate-950/20 transition-colors duration-500">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {loading ? (
            [...Array(6)].map((_, index) => (
              <div 
                key={index} 
                className="glass-panel p-6 rounded-2xl animate-pulse h-48 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/5 flex flex-col justify-between"
              >
                <div className="flex justify-between items-start gap-4">
                  <div className="flex items-center gap-3">
                    <div className="h-10 w-10 rounded-xl bg-slate-200 dark:bg-white/5 shrink-0" />
                  ...
                  <div className="h-6 w-16 bg-slate-200 dark:bg-white/5 rounded" />
                </div>
                ...
                <div className="flex gap-2">
                  <div className="h-6 w-20 bg-slate-200 dark:bg-white/5 rounded-lg" />
                  <div className="h-6 w-16 bg-slate-200 dark:bg-white/5 rounded-lg" />
                  <div className="h-6 w-16 bg-slate-200 dark:bg-white/5 rounded-lg" />
                </div>
              </div>
            ))
          ) : featuredJobs.length <= 0 ? (
            <div className="col-span-full text-center py-12 glass-panel rounded-2xl border-slate-200 dark:border-white/5">
              <span className="text-slate-500 dark:text-slate-400 text-sm font-semibold">No Featured Jobs Available At The Moment</span>
            </div>
          ) : (
