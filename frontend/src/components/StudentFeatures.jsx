        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 order-2 lg:order-1 relative">
            ...
            <motion.div
              ...
              className="bg-white dark:bg-gradient-to-br dark:from-[#0F172A] dark:via-[#111827] dark:to-[#0B1220] border border-slate-200 dark:border-white/10 p-6 rounded-3xl shadow-[0_20px_60px_rgba(15,23,42,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.35)] relative overflow-hidden"
            >
              ...
              {features.map((feat) => {
                ...
                return (
                  <div key={feat.title} className="relative group/card rounded-3xl">
                    <div className="bg-white dark:bg-gradient-to-br dark:from-[#0F172A] dark:via-[#111827] dark:to-[#0B1220] border border-slate-200 dark:border-white/10 p-5 rounded-3xl flex flex-col gap-3 transition-all duration-300 hover:-translate-y-1.5 shadow-[0_15px_40px_rgba(15,23,42,0.05)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.35)] hover:shadow-[0_25px_50px_rgba(15,23,42,0.08)] dark:hover:shadow-[0_30px_80px_rgba(0,0,0,0.5)] h-full relative z-10">
